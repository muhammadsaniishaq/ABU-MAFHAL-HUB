                ...
                <View style={styles.detailOverlay}>
                    {selectedHistoryItem && (
                        <View style={styles.detailCard}>
                            {/* Card Header Banner */}
                            <LinearGradient colors={['#9A3412', '#7C2D12']} style={styles.detailHeader}>
            ...
            <ScrollView style={{ flex: 1, paddingHorizontal: 12 }} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.card}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Ionicons name="time" size={18} color="#9A3412" style={{ marginRight: 6 }} />
...
console.log('Successfully implemented premium horizontal history table and detail modal popup in ipe-clearance.tsx!');
