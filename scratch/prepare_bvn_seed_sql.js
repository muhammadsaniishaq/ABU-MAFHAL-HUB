...
const sqlPath = path.join(__dirname, '../supabase/seed_bvn_verification.sql');

const sqlContent = `-- 1. Remove old/obsolete BVN pricing entries
...
console.log('Successfully created supabase/seed_bvn_verification.sql!');
