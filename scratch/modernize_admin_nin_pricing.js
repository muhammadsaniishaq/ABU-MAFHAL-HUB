...
const modernizedAdminPricingCode = `import { View, Text, TouchableOpacity, ScrollView, ActivityIndicator, Modal, TextInput, StyleSheet, Platform, KeyboardAvoidingView } from 'react-native';
...
fs.writeFileSync(targetPath, modernizedAdminPricingCode, 'utf8');
console.log('Successfully modernized nin-pricing.tsx with premium UI aesthetics!');
