-- 0. Clean up existing triggers and the public schema (destructive but approved by user)
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users CASCADE;
DROP SCHEMA IF EXISTS public CASCADE;
CREATE SCHEMA public;

-- Restore permissions to the public schema
...
-- Create uuid_generate_v4 wrapper function in public schema to guarantee compatibility
