        ...
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'flex-end' }}>
          <View style={{ backgroundColor: '#ffffff', borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 20, maxHeight: '85%' }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              <Text style={{ color: '#64748b', fontSize: 10, fontWeight: '900', marginBottom: 4 }}>From (Domain Sender)</Text>
              <View style={{ backgroundColor: '#0f172a', padding: 12, borderRadius: 12, marginBottom: 12 }}>
                <Text style={{ color: '#f5a623', fontWeight: '900', fontSize: 13 }}>{senderAccount}</Text>
              </View>

              <Text style={{ color: '#64748b', fontSize: 10, fontWeight: '900', marginBottom: 4 }}>Recipient Email</Text>
              <TextInput 
              ...
              <Text style={{ color: '#64748b', fontSize: 10, fontWeight: '900', marginBottom: 4 }}>Subject</Text>
              <TextInput 
              ...
              <Text style={{ color: '#64748b', fontSize: 10, fontWeight: '900', marginBottom: 4 }}>Message Body</Text>
              <TextInput 
                ...
                multiline
                numberOfLines={6}
                style={{ backgroundColor: '#f8fafc', borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 12, color: '#0f172a', fontWeight: '600', fontSize: 13, minHeight: 120, textAlignVertical: 'top', marginBottom: 16 }}
              />
