...
const REQUIRED_SECRETS = [
    ...
    { key: 'FLUTTERWAVE_SECRET_KEY', aliases: ['FLUTTERWAVE_KEY', 'FLUTTERWAVE_SECRET'], desc: 'Flutterwave Secret Key for Instant Bank Payouts', provider: 'Flutterwave' },
    { key: 'FLUTTERWAVE_PUBLIC_KEY', aliases: ['FLUTTERWAVE_PUB'], desc: 'Flutterwave Public Key', provider: 'Flutterwave' },
    { key: 'FLUTTERWAVE_SECRET_HASH', aliases: ['FLUTTERWAVE_HASH'], desc: 'Flutterwave Webhook Verification Secret Hash', provider: 'Flutterwave' },
