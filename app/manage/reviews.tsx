...
const s = StyleSheet.create({
  ...
  headerSubTitle: { fontSize: 11, color: COLORS.textSub, marginTop: 1 },
  ...
  addBtnTxt: { fontSize: 11, fontWeight: 'bold', color: COLORS.white },
  ...
  chipTxt: { fontSize: 11, color: COLORS.textSub, fontWeight: '600' },
  ...
  catTxt: { fontSize: 10, color: COLORS.textSub },
  dateTxt: { fontSize: 9, color: COLORS.textSub, marginTop: 2 },
  badgeActive: { backgroundColor: '#ecfdf5', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  badgeActiveTxt: { fontSize: 8, fontWeight: 'bold', color: COLORS.success },
  badgeHidden: { backgroundColor: '#fef2f2', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  badgeHiddenTxt: { fontSize: 8, fontWeight: 'bold', color: COLORS.error },
  ...
  actionBtnTxt: { fontSize: 10, fontWeight: 'bold', color: COLORS.navy },
  ...
  label: { fontSize: 11, fontWeight: 'bold', color: COLORS.navy, marginBottom: 4, marginTop: 8 },
  ...
  modalChipTxt: { fontSize: 10, color: COLORS.textSub, fontWeight: '600' },
